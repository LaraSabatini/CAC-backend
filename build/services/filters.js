...
const getFilters = (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const [filters] = yield index_1.default.query(`SELECT * FROM themes`);
        if (filters) {
            return res
...
const createFilter = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const insertFilter = yield index_1.default.query(`INSERT INTO themes (value) VALUES ('${value}');`);
        if (insertFilter) {
...
const deleteFilter = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const [filter] = yield index_1.default.query(`DELETE FROM themes WHERE id=${id}`);
        if (filter) {
