...
import { adminRegister, adminLogin, adminChangePassword, getAdminData, editAdminData, restoreAdminPasswordEmail, } from "../services/adminAuth";
import { clientRegister, clientLogin, clientChangePassword, validateEmail, validateIdentificationNumber, getClientData, editClientData, blockAccount, registerSuccessEmail, restoreClientPasswordEmail, updateClientPaymentData, getClientDataForTable, accountBlockedNotificationEmail, accountUnblockedNotificationEmail, } from "../services/clientAuth";
...
router.post("/client/validate-identification_number", validateIdentificationNumber);
